...
public class SettingsActivity extends SherlockPreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		createIpTextWatcherForPreference("general_ip_address");
		...
		createIpTextWatcherForPreference("logic_ip_address");

		// Bind the summaries of EditText/List/Dialog/Ringtone preferences to
		// their values. When their values change, their summaries are updated
		// to reflect the new value, per the Android Design guidelines.
		bindPreferenceSummaryToValue(findPreference("general_ip_address"));
		...
		bindPreferenceSummaryToValue(findPreference("logic_port"));
		bindPreferenceSummaryToValue(findPreference("logic_ip_address"));
	}
