 ...
 * 2012-06-04T20:55:26.875+02:00
 * Generated source version: 2.4.3-fuse-01-02
 * 
 */
@WebServiceClient(name = "Service", 
                  wsdlLocation = "file:/M:/servicemix_equinox/data/pax-web-jsp/SensorsService_orig.wsdl",
...
public class Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/M:/servicemix_equinox/data/pax-web-jsp/SensorsService_orig.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/M:/servicemix_equinox/data/pax-web-jsp/SensorsService_orig.wsdl");
        }
        WSDL_LOCATION = url;
    }
