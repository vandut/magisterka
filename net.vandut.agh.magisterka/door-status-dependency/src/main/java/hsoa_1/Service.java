 ...
 * 2012-04-19T15:38:20.985+02:00
 * Generated source version: 2.4.3
 * 
 */
@WebServiceClient(name = "Service", 
                  wsdlLocation = "M:/WSDL/DoorService_final.wsdl",
...
public class Service extends javax.xml.ws.Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("M:/WSDL/DoorService_final.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "M:/WSDL/DoorService_final.wsdl");
        }
        WSDL_LOCATION = url;
    }
